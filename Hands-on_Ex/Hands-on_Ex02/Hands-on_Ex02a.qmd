...
In this section, we would like to further our analysis at the planning area level. For simplicity reason, we will focus on Punggol, Tampines, Hougang and Serangoon planning areas.
...
In the code chunk below, [*clarkevans.test()*](https://rdrr.io/cran/spatstat/man/clarkevans.test.html) of **spatstat** is used to performs Clark-Evans test of aggregation for childcare centre in Hougang planning area.
...
#| fig-width: 12
#| fig-height: 10
par(bg = "#e6f0e6", mfrow = c(2,2), mar = c(3, 3, 3, 3))
