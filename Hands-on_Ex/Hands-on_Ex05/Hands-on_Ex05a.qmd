...
::: markgoals-container
There is statistically significant positive spatial autocorrelation in GDP per capita across Hunan province.
-   p-value = 0.001 indicates strong statistical significance
-   Observed rank = 1000 means observed Moran's I value was the highest among all 1000 values. This means none of the 999 random permutations produced a Moran's I value as high as the observed value.
-   Moran's I = 0.30075 confirms moderate positive spatial autocorrelation. Areas with similar GDP per capita are significantly clustered together geographically.
:::
:::::
