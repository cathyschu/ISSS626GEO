...
```
**Positive ii means:** Location has similar values to its neighbors (clustering)
**Negative ii means:** Location has different values from neighbors (spatial outlier)
