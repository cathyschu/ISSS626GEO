...
We have the following objectives to achieve: - to import GIS polygon data into R and save them as simple feature data frame by using appropriate functions of sf package of R - to import aspatial data into R and save them as simple feature data frame by using appropriate functions of sf package of R - to computer accessibility measure by using Hansen’s potential model and Spatial Accessibility Measure (SAM) - to visualise the accessibility measures by using tmap and ggplot2 packages
