...
write_rds(condo.slr, "data/rds/condo.slr.rds")
```

```{r}
#| echo: false
condo.slr <- read_rds("data/rds/condo.slr.rds")
```
...
write_rds(condo.mlr, "data/rds/condo.mlr.rds")
```

```{r}
#| echo: false
condo.mlr <- read_rds("data/rds/condo.mlr.rds")
```
...
write_rds(condo.mlr1, "data/rds/condo.mlr1.rds")
```

```{r}
#| echo: false
condo.mlr1 <- read_rds("data/rds/condo.mlr1.rds")
```
...
write_rds(bw.fixed, "data/rds/bw.fixed.rds")
```
...
write_rds(gwr.fixed, "data/rds/gwr.fixed.rds")
```
