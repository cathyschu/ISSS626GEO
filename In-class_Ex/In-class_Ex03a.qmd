...
```{r}
#do one simulation to make sure they push away the overlapping data points, to avoid overlapping problem, which caused a spike at the beggining of the line.
...
Lcsr_df <- as.data.frame(L_tm.csr) #change this part only
...
::: markgoals-container
To help us determine at what distance, we can observe the clusters. For example, we start seeing clustering around 23 meters apart.
:::
:::::
