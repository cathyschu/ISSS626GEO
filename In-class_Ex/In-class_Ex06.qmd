---
title: "06 -Take-home Exercise 2 Kick starter"
author: "Cathy C."
date: "Oct 4, 2025"
...
### 3.1 Import *Master Plan 2019 Subzone Boundary data*
...
### 3.2 Import B*us Stop Location* shapfile
...
### 3.3 Import *Passenger Volume by Origin Destination Bus Stops*
...
## 4 Extracting bus stops in Singapore
...
## 5.1 Filtering hexagons with bus stops
...
## 7 Prepare trip generation data

### 7.1 Clearing the data

We dont need the desination code
...
### 7.2 Add HEX_ID into bus trips data
...
space - time cube \> then perform emerging hot spot analysis.
