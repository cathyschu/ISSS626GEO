...
```{r}
sapply(HDB_master[, c(4, 6, 8:28)], class)
```


We will do a multicollinearity analysis with the correlatiom matrix. 
```{r}
#| fig-width: 12
#| fig-height: 10
#| code-fold: true
par(bg = "#B8C4A9") 
corrplot(cor(st_drop_geometry(HDB_master)[, c(4, 6, 8:27)]),
         diag = FALSE, 
         order = "AOE",
         tl.pos = "td", 
         tl.cex = 0.7, 
