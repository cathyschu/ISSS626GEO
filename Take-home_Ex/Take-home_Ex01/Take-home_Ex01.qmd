...
::: notegoals-container
New laundry businesses show a clear spatial pattern that aligns with both residential density and commercial activity. **Residential Area Patterns**: Laundry businesses concentrate in high-density residential areas. Areas with lower population density show correspondingly fewer or no new laundry establishments, which suggests a strong relationship between residential demand and business location decisions.
...
::: notegoals-container
Laundry service R = 0.59189 & p-value = 0.01 shows there are some clustering in residential areas. It is more dispersed to serve neighbourhood needs, but it is not random.
:::
:::::
...
::: notegoals-container
Beauty services R = 0.36 & p-value = 0.01 indicates that they are not random.
:::
:::::
...
::: notegoals-container
Dental service R = 0.49043 & p-value = 0.01 shows moderate clustering. This is possibly due to medical professional buildings or proximity to hospitals.
:::
:::::
::: 
...
We will compute Kernel Density Estimation (KDE) to visualise and analyse first-order spatial point patterns. We use adaptive bandwidth because all 3 business types show clustering with varying intensities, and adaptive approach handles multi-scale density variations beter than fixed bandwidth by using finer resolution in high-density areas and broader smoothing in sparse regions.
...
::: notegoals-container
The adaptive KDE output reveals a clustered spatial pattern with distinct concentration hierarchies across Singapore.
