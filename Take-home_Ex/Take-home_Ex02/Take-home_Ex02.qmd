...
Below charts are plotted to have a full picture of the volume of each Hex ID in a descending manner.
...
```
**Insight: **
- When looking at the fixed internal of PM peak hour trips, majority of the areas are below 500K, several between 500K-1000K. We hardly see any hexagon area between 1000K-1,500K. However, there are a few hexagon areas showing trips totalling more than 1,500K in PM peak hours; these hexagons fall into the Woodlands regional centre subzone, Jurong West Central, Tampines West. We noticed that these hexagons have Woodlands, Boon Lay and Tampines MRT stations within or around the border of the respective hexagons. 
- This shows that at the PM peak time, many people board the bus from these areas. This could be due to passengers take bus after they get off from the MRT stations and take the bus to the stop near their homes.
- <fill in>
...
Analysis: 
- LMSA statistic of the passengers trips generate by origin at hexagon level.
