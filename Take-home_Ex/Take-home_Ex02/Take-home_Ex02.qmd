...
-   The **highest positive ii (Moran's I)** is the hexagon where **Boon Lay station** is, which has the highest ridership among all period of time, followed by some of its neighbor hexagons, Tampines, Sengkang Town Center, Clementi, and Ang Moh Kio Town Center.

-   The **lowest negative ii** is the hexagon where **Joo Koon station** is, which differs from its neighbors (surrounding neighbors all have very low riderships.) Possibly because there are some factories in this area, and people would have to take the bus from here to the nearest point to their work.

-   **High ii + Low p-value** includes Jurong West Central area, Tampines, Sengkang Town Center, Clementi, and Ang Moh Kio Town Center, showing strong, statistically significant clustering.

-   **Negative ii + High p-value** includes Joo Koon, meaning that there could be apparent clustering but could be random. In this case, we can probably ignore this.
...
-   The highest positive ii (Moran's I) is the hexagon at **Tampines and Sengkang Town Center**, followed by **Bras basah, Jurong West Central, Bedok, and Ang Mo Kio**.
-   The lowest negative ii is the hexagon at **Choa Chu Kang**. Choa Chu Kang and the neighboring hexagons differ from their neighbors.
-   High ii + Low p-value includes **Bedok, Tampines, Sengkang Town Center, Bras basah, Ang Mo Kio, as well as Jurong West Central**, showing strong, statistically significant clustering.
-   Negative ii + Low p-value includes Choa Chu Kang, hexagons near Woodlands checkpoint, and Bukit Panjang areas, indicating they are significant spatial outliers. For this case, it's more likely they have lower ridership.
...
-   The highest positive ii (Moran's I) is the hexagon at **Bedok and Tampines**, which has the consistently very high ridership among all period of time, followed by one of its neighbor hexagons, **Sengkang Town Center, Bras basah, and Ang Mo Kio**. Jurong West Central is also high, but not as the previously mentioned areas.
-   The lowest negative ii is the hexagon at **Choa Chu Kang and Woodlands Checkpoint**. They differs from its neighbors.
-   High ii + Low p-value includes **Bedok, Tampines, Sengkang Town Center, Bras basah, Ang Mo Kio, as well as Jurong West Central**, showing strong, statistically significant clustering. Bras Basah & Bugis areas are especially strong.
-   Negative ii + Low p-value includes hexagons near Woodlands checkpoint, indicating they are significant spatial outliers. For this case, it's more likely they have lower ridership despite being near Woodlands checkpoint - higher-ridership zones.
:::
...
New coldspots appear predominantly at border areas adjacent to persistent coldspots, while Kampong Ubi is the only new hotspot observed. The absence of emerging high-demand centers indicates the network is **consolidating around existing hubs rather than expanding during July-September 2025.**
...
-   Unlike AM where coldspots are firmly established (persistent), PM shows more temporal variation in low-ridership areas. Areas like Bayfront & Straits View, Tanjong Rhu, Changi, Punggol, and Tuas shift between cold and non-cold states. The shift from persistent to consecutive/sporadic coldspots indicates these areas occasionally experience higher ridership during PM peaks. This could be due to return trips from work or evening activities like dining and shopping temporarily boost demand.

-   Persistent and consecutive hotspots are significantly reduced in PM peaks, appearing only in Tampines and Jurong West. Notably, Woodlands - a major AM persistent hotspot - shows no persistent hotspots in PM, only consecutive and sporadic patterns. The remaining hotspot clusters across Bukit Panjang, Bukit Batok, Clementi, Toa Payoh, Serangoon, Hougang, Sengkang, Bedok, Little India, Boat Quay, Maxwell, Tanjong Pagar, and Redhill consist mainly of sporadic hotspots.
...
-   Weekend patterns show more persistent hotspots compared to PM peaks, concentrated at major hubs like Tampines, Woodlands, Ang Mo Kio, Sengkang, and the city center corridor from Lavender to Chinatown and Redhill, encompassing Little India, Bras Basah, Dhoby Ghaut. Notably, Boon Lay/Jurong West show intensifying hotspots, forming larger consolidated clusters. The city center forms the most extensive hotspot zone, combining sporadic and persistent patterns, with Woodlands, Tampines, and Boon Lay standing out as the most prominent weekend boarding hubs.

-  **Border locations display persistent coldspots during weekends**, contrasting with weekday activity. New coldspots continue expanding at borders, connecting to existing persistent coldspot clusters. This weekend-weekday disparity confirms border areas are primarily industrial/commercial zones where ridership is employment-driven rather than residential or recreational, with minimal activity during time off.

-   New coldspots emerge not only at borders (connecting persistent coldspot clusters) but also at Ulu Pandan and Tagore, suggesting **expanding underutilisation in non-border areas**. Interestingly, some new coldspots like Waterway East and Toh Tuck appear adjacent to hotspot clusters, indicating pockets of low ridership surrounded by high-demand zones - potentially reflecting physical barriers, land use discontinuities, or service coverage gaps.
